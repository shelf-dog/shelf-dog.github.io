States = () => {
  ...
  const STATE_CONFIG = "config",
        ...
        STATE_LIBRARY_READONLY = "library-readonly",
        ...
        STATES = [
          ...
          STATE_LIBRARIES, STATE_LIBRARIES_LOADED, STATE_LIBRARIES_OVERVIEW, STATE_LIBRARIES_MULTIPLE, STATE_LIBRARIES_SINGLE, STATE_LIBRARIES_SELECTING, STATE_LIBRARIES_WORKING,
          STATE_LIBRARY, STATE_LIBRARY_WORKING, STATE_LIBRARY_LOADED, STATE_LIBRARY_NONE, STATE_LIBRARY_MANAGEABLE, STATE_LIBRARY_LOANABLE, STATE_LIBRARY_ITEM, STATE_LIBRARY_AVAILABLE, STATE_LIBRARY_RETURNABLE, STATE_LIBRARY_REQUESTABLE, STATE_LIBRARY_READONLY,
  ...
  return {
    ...
    libraries : {
      ...
      working : STATE_LIBRARIES_WORKING,
    },
    ...
    library : {
      ...
      readonly : STATE_LIBRARY_READONLY,
      specific :[
        STATE_LIBRARY_NONE,
